...
const startText =
    'Добро пожаловать! Чат-бот SFMeetingReminder предназначен для того, чтобы напоминать ' +
...
authScene.enter(async (ctx) => {
    ...
    if (instance) {
        ...
        await ctx.reply(
            `Добро пожаловать, ${ctx.message.from.first_name}. Вы уже авторизованы как: ${employee.email}`,
        )
